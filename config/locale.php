...
$availableLocalesAdmin = explode(',', env('APP_AVAILABLE_LOCALE_ADMIN', 'en'));
$availableLocalesClient = explode(',', env('APP_AVAILABLE_LOCALE_CLIENT', 'en'));

$allLocales = [
    'en' => ['name' => 'English', 'script' => 'Latn', 'native' => 'English', 'regional' => 'en_GB', 'flag' => 'us'],
    'uk' => ['name' => 'Ukrainian', 'script' => 'Cyrl', 'native' => 'Українська', 'regional' => 'uk_UA', 'flag' => 'ua'],
    'pl' => ['name' => 'Polish', 'script' => 'Latn', 'native' => 'Polski', 'regional' => 'pl_PL', 'flag' => 'pl'],
    'fr' => ['name' => 'French', 'script' => 'Latn', 'native' => 'Français', 'regional' => 'fr_FR', 'flag' => 'fr'],
...
$adminLocales = array_filter($allLocales, function ($key) use ($availableLocalesAdmin) {
    return in_array($key, $availableLocalesAdmin);
}, ARRAY_FILTER_USE_KEY);

$clientLocales = array_filter($allLocales, function ($key) use ($availableLocalesClient) {
    return in_array($key, $availableLocalesClient);
}, ARRAY_FILTER_USE_KEY);

return [
    'admin' => [
        'default' => env('APP_DEFAULT_LOCALE_ADMIN', 'en'),
        'locales' => $adminLocales,
    ],

    'client' => [
        'default' => env('APP_DEFAULT_LOCALE_CLIENT', 'en'),
