...
if (! function_exists('view_admin')) {
    ...
    function view_admin($view, $data = [], $mergeData = []): \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\Contracts\View\View
    {
...
if (! function_exists('view_admin_module')) {
    ...
    function view_admin_module($type, $name, $view, $data = [], $mergeData = []): \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\Contracts\View\View
    {
...
if (! function_exists('view_client')) {
    ...
    function view_client($view, $data = [], $mergeData = []): \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\Contracts\View\View
    {
...
if (! function_exists('logModule')) {
     ...
     */
    function logModule(string $type, string $name, string $action, string $level, mixed $request = [], mixed $response = []): void
    {
...
if (! function_exists('loadModulesNamespaces')) {
    function loadModulesNamespaces(): void
    {
        ...
        foreach ($modules as $module) {
            ...
            $controllersPath = base_path("modules/{$module->type}/{$module->name}/Services");
            if (is_dir($controllersPath)) {
                foreach (glob($controllersPath.'/*.php') as $file) {
                    require_once $file;
                }
