...
class Module
{
    ...
    public function logInfo(string $action, array|string $request = [], array|string $response = []): void
    {
        logModule(
            $this->module_type,
            $this->module_name,
    ...
    public function logError(string $action, array|string $request = [], array|string $response = []): void
    {
        logModule(
            $this->module_type,
            $this->module_name,
