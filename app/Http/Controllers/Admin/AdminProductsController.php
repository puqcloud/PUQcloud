...
class AdminProductsController extends Controller
{
        ...
        return response()->json([
            'data' => DataTables::of($query)
                ...
                ->addColumn('urls', function ($price) use ($uuid) {
                    ...
                    $urls['delete'] = route('admin.api.product.price.delete', ['uuid' => $uuid, 'p_uuid' => $price->uuid]);
        ...
        return response()->json([
            'data' => DataTables::of($query)
                ...
                ->addColumn('urls', function ($product_attribute) use ($uuid) {
                    $urls['web_edit'] = route('admin.web.product_attribute_group.tab', ['uuid' => $uuid, 'tab' => 'attributes', 'edit' => $product_attribute->uuid]);
                    $urls['delete'] = route('admin.api.product.product_attribute.delete', ['uuid' => $uuid, 'pa_uuid' => $product_attribute->uuid]);
        ...
        return response()->json([
            'data' => DataTables::of($query)
                ...
                ->addColumn('urls', function ($product_option_group) use ($uuid) {
                    $urls['web_edit'] = route('admin.web.product_option_group.tab', ['uuid' => $product_option_group->uuid, 'tab' => 'general']);
                    $urls['delete'] = route('admin.api.product.product_option_group.delete', ['uuid' => $uuid, 'pog_uuid' => $product_option_group->uuid]);
        ...
        return response()->json([
            'data' => DataTables::of($query)
                ...
                ->addColumn('urls', function ($product_group) {
                    $urls['web_edit'] = route('admin.web.product_group.tab', ['uuid' => $product_group->uuid, 'tab' => 'general']);
        ...
        return response()->json([
            'data' => DataTables::of($query)
                ...
                ->addColumn('urls', function ($product) use ($uuid) {
                    $urls['web_edit'] = route('admin.web.product.tab', ['uuid' => $product->uuid, 'tab' => 'general']);
                    $urls['delete'] = route('admin.api.product_group_product.delete', ['uuid' => $uuid, 'p_uuid' => $product->uuid]);
    ...
    public function productAttributeGroupTab(Request $request, $uuid, $tab): View|RedirectResponse
    {
        ...
        return view_admin('product_attribute_groups.product_attribute_group_'.$tab, compact('title', 'uuid', 'tab', 'locales'));
    }
        ...
        return response()->json([
            'data' => DataTables::of($query)
                ...
                ->addColumn('urls', function ($product_attribute_group) {
                    $urls['web_edit'] = route('admin.web.product_attribute_group.tab', ['uuid' => $product_attribute_group->uuid, 'tab' => 'general']);
    ...
    public function postProductAttributeGroup(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'redirect' => route('admin.web.product_attribute_group.tab', ['uuid' => $product_attribute_group->uuid, 'tab' => 'general']),
        ]);
    }
        ...
        return response()->json([
            'data' => DataTables::of($query)
                ...
                ->addColumn('images', function ($query) {
                    // $query->loadImagesField();
                    return $query->images;
                })
                ->addColumn('urls', function ($product_attribute) {
                    $urls['web_edit'] = route('admin.web.product_attribute_group.tab', ['uuid' => $product_attribute->product_attribute_group_uuid, 'tab' => 'attributes', 'edit' => $product_attribute->uuid]);
    ...
    public function postProductAttributeGroupProductAttribute(Request $request, $uuid): JsonResponse
    {
        ...
        return response()->json([
            ...
            'redirect' => route('admin.web.product_attribute_group.tab', ['uuid' => $product_attribute_group->uuid, 'tab' => 'attributes', 'edit' => $product_attribute->uuid]),
        ]);
    }
    ...
    public function getProductAttribute(Request $request, $uuid): JsonResponse
    {
        ...
        // $product_attribute->loadImagesField();
    ...
    public function productOptionGroupTab(Request $request, $uuid, $tab): View|RedirectResponse
    {
        ...
        return view_admin('product_option_groups.product_option_group_'.$tab, compact('title', 'uuid', 'tab', 'locales'));
    }
        ...
        return response()->json([
            'data' => DataTables::of($query)
                ...
                ->addColumn('urls', function ($query) {
                    return [
                        'web_edit' => route('admin.web.product_option_group.tab', ['uuid' => $query->uuid, 'tab' => 'general']),
    ...
    public function postProductOptionGroup(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'redirect' => route('admin.web.product_option_group.tab', ['uuid' => $product_option_group->uuid, 'tab' => 'general']),
        ]);
    }
        ...
        return response()->json([
            'data' => DataTables::of($query)
                ...
                ->addColumn('urls', function ($product_option) {
                    $urls['web_edit'] = route('admin.web.product_option_group.tab', ['uuid' => $product_option->product_option_group_uuid, 'tab' => 'options', 'edit' => $product_option->uuid]);
    ...
    public function postProductOptionGroupProductOption(Request $request, $uuid): JsonResponse
    {
        ...
        return response()->json([
            ...
            'message' => __('message.Created successfully'),
            'data' => $product_option,
            'redirect' => route('admin.web.product_option_group.tab', ['uuid' => $product_option_group->uuid, 'tab' => 'options', 'edit' => $product_option->uuid]),
        ]);
    }
    ...
    public function getProductOption(Request $request, $uuid): JsonResponse
    {
        ...
        // $product_option->loadImagesField();
    ...
    public function getProductOptionPrices(Request $request, $uuid): JsonResponse
    {
        ...
        return response()->json([
            'data' => DataTables::of($query)
                ...
                ->addColumn('urls', function ($price) use ($uuid) {
                    $urls['edit'] = route('admin.api.product_option.price.get', ['uuid' => $uuid, 'p_uuid' => $price->uuid]);
                    $urls['delete'] = route('admin.api.product_option.price.delete', ['uuid' => $uuid, 'p_uuid' => $price->uuid]);
