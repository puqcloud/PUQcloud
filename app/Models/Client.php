...
class Client extends Model
{
    ...
    public function getAddFundsParams(): array
    {
        ...
        return [
            ...
            'min_add_funds_amount' => round($min_add_funds_amount, 2),
            'max_add_funds_amount' => round($max_add_funds_amount, 2),
            'max_client_balance' => round($max_client_balance, 2),
    ...
    public function calculateRecurringPaymentsBreakdown(): array
    {
        ...
        $totals = [
            'hourly' => round($totalHourly, 4),
            'daily' => round($totalHourly * 24, 2),
            'weekly' => round($totalHourly * 168, 2),
            'monthly' => round($totalHourly * 720, 2),
            'yearly' => round($totalHourly * 8760, 2),
            'recommended_funds' => round($this->calculateRecommendedAddFundsAmount(), 2),
            'currency' => $currency,
        ];
