...
class Module extends Model
{
    ...
    {
        if (empty($this->module)) {
            logActivity('error', 'Module '.$this->name.' deactivate Error: Failed to create module object', 'deactivate');
    ...
    public function moduleExecute(string $methodName, ...$parameters): array
    {
        if (empty($this->module)) {
            return [
                'status' => 'error',
