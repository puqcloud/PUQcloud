...
class AdminSidebarService
{
    ...
    public function getMenu(): array
    {
        ...
        foreach ($this->menu as $itemKey => &$item) {
            if ($item['title'] == 'Customization') {
                $item['subItems'] = array_merge($item['subItems'], $this->getAdminTemplatesSidebar(), $this->getClientTemplatesSidebar(), $this->getModulesSidebar());
            }
        }
    ...
    protected function getModulesSidebar(): array
    {
        $menu = [];
        $modules = app('Modules');
