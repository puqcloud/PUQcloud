                        ...
                        <div class="row">
                            <div
                                ...
                                <div class="form-group">
                                    <label for="credit_note_template">{{__('main.Template')}}</label>
                                    <textarea name="credit_note_template" id="credit_note_template" class="form-control"
                                              rows="20"></textarea>
                                </div>
                            </div>
                            <div
    ...
    <script>
        $(document).ready(function () {
            ...
            function loadFormData() {
                ...
                PUQajax('{{route('admin.api.home_company.get', $uuid)}}', {}, 1500, null, 'GET')
                    .then(function (response) {
                        ...
                        $("#credit_note_template").val(response.data?.credit_note_template);

                        if (!editor) {
                            editor = CodeMirror.fromTextArea(document.getElementById('credit_note_template'), {
                            ...
                            editor.setValue(response.data.credit_note_template || '');
                        }

                        updateHtmlPreview(response.data.credit_note_template || '');
                        if (response.data) {
            ...
            function loadTemplateContent(templateName) {
                ...
                PUQajax(`{{route('admin.api.home_company.invoice_template.get', 'credit_note')}}?name=${templateName}`, {}, 1500, $button, 'GET')
                    .then(function (response) {
                        if (editor) {
            ...
            function loadInvoiceTemplates() {
                PUQajax('{{ route('admin.api.home_company.invoice_templates.get', 'credit_note') }}', {}, 1500, null, 'GET')
                    .then(function (response) {
