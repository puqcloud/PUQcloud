                        ...
                        <div class="row">
                            <div
                                ...
                                <div class="form-group">
                                    <label for="invoice_template">{{__('main.Template')}}</label>
                                    <textarea name="invoice_template" id="invoice_template" class="form-control"
                                              rows="20"></textarea>
                                </div>
                            </div>
                            <div
    ...
    <script>
        $(document).ready(function () {
            ...
            function loadFormData() {
                ...
                PUQajax('{{route('admin.api.home_company.get', $uuid)}}', {}, 1500, null, 'GET')
                    .then(function (response) {
                        ...
                        $("#invoice_template").val(response.data?.invoice_template);

                        if (!editor) {
                            editor = CodeMirror.fromTextArea(document.getElementById('invoice_template'), {
                            ...
                            editor.setValue(response.data.invoice_template || '');
                        }

                        updateHtmlPreview(response.data.invoice_template || '');
                        if (response.data) {
            ...
            function loadTemplateContent(templateName) {
                ...
                PUQajax(`{{route('admin.api.home_company.invoice_template.get', 'invoice')}}?name=${templateName}`, {}, 1500, $button, 'GET')
                    .then(function (response) {
                        if (editor) {
            ...
            function loadInvoiceTemplates() {
                PUQajax('{{ route('admin.api.home_company.invoice_templates.get', 'invoice') }}', {}, 1500, null, 'GET')
                    .then(function (response) {
