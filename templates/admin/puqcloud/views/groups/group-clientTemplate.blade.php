            ...
            <form id="group" class="col-md-10 mx-auto" method="post" action="" novalidate="novalidate">
                <div class="row">
                    ...
                    <div class="col-12 mb-1">
                        <div id="clientTemplate_permissions" class="row"></div>
                    </div>
...
@section('js')
    ...
    <script>
            ...
            function loadFormData() {
                ...
                PUQajax('{{route('admin.api.group.get', $uuid)}}', {}, 50, null, 'GET')
                    .then(function (response) {
                        ...
                        if (response.data.clientTemplate_permissions) {
                            var $clientTemplatePermissionsDiv = $('#clientTemplate_permissions');
                            $clientTemplatePermissionsDiv.empty();

                            var groupedPermissions = {};

                            response.data.clientTemplate_permissions.forEach(function(clientTemplate_permission) {
                                var group = clientTemplate_permission.key_group;

                                if (!groupedPermissions[group]) {
                                    groupedPermissions[group] = [];
                                }

                                groupedPermissions[group].push(clientTemplate_permission);
                            });
        ...
        `;
                                ...
                                permissions.forEach(function(clientTemplate_permission) {
                                    var checked = clientTemplate_permission.is_linked ? 'checked' : '';
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="widget-content mb-3 card-shadow-primary border-primary">
                        <div class="widget-content-wrapper">
                            ...
                            <div class="widget-content-left">
                                <div class="widget-heading">${clientTemplate_permission.name}</div>
                                <div class="widget-subheading">
                                    ${clientTemplate_permission.description ? clientTemplate_permission.description : '***'}
                                </div>
                            </div>
                            <div class="widget-content-right">
                                <div class="widget-numbers text-primary">
                                    <span class="count-up-wrapper">
                                        <input type="checkbox" id="checkbox_${clientTemplate_permission.key}" name="clientTemplate_permissions[${clientTemplate_permission.key}]"
        ...
        `;
                                ...
                                $clientTemplatePermissionsDiv.append(cardHtml);
                            });
                        }
