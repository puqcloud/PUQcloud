            ...
            <form id="group" class="col-md-10 mx-auto" method="post" action="" novalidate="novalidate">
                <div class="row">
                    ...
                    <div class="col-12 mb-1">
                        <div id="adminTemplate_permissions" class="row"></div>
                    </div>
...
@section('js')
    ...
    <script>
            ...
            function loadFormData() {
                ...
                PUQajax('{{route('admin.api.group.get', $uuid)}}', {}, 50, null, 'GET')
                    .then(function (response) {
                        ...
                        if (response.data.adminTemplate_permissions) {
                            var $adminTemplatePermissionsDiv = $('#adminTemplate_permissions');
                            $adminTemplatePermissionsDiv.empty();

                            var groupedPermissions = {};

                            response.data.adminTemplate_permissions.forEach(function(adminTemplate_permission) {
                                var group = adminTemplate_permission.key_group;

                                if (!groupedPermissions[group]) {
                                    groupedPermissions[group] = [];
                                }

                                groupedPermissions[group].push(adminTemplate_permission);
                            });
        ...
        `;
                                ...
                                permissions.forEach(function(adminTemplate_permission) {
                                    var checked = adminTemplate_permission.is_linked ? 'checked' : '';
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="widget-content mb-3 card-shadow-primary border-primary">
                        <div class="widget-content-wrapper">
                            ...
                            <div class="widget-content-left">
                                <div class="widget-heading">${adminTemplate_permission.name}</div>
                                <div class="widget-subheading">
                                    ${adminTemplate_permission.description ? adminTemplate_permission.description : '***'}
                                </div>
                            </div>
                            <div class="widget-content-right">
                                <div class="widget-numbers text-primary">
                                    <span class="count-up-wrapper">
                                        <input type="checkbox" id="checkbox_${adminTemplate_permission.key}" name="adminTemplate_permissions[${adminTemplate_permission.key}]"
        ...
        `;
                                ...
                                $adminTemplatePermissionsDiv.append(cardHtml);
                            });
                        }
