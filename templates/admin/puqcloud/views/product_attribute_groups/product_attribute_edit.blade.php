    ...
    <div class="mb-3 card">
        <div class="card-header-tab card-header">
            <div class="card-header-title font-size-lg text-capitalize fw-normal">
                ...
                {{ __('main.Editing an Attribute') }}
            </div>
        </div>
        <div class="card-body">
            <form id="product_attribute" class="mx-auto" novalidate="novalidate">
    ...
    <script>
        $(document).ready(function () {
            ...
            function loadFormData(locale) {
                blockUI('product_attribute');
                const $form = $('#product_attribute');

                $form[0].reset();
                resetFormValidation($form);

                PUQajax('{{route('admin.api.product_attribute.get', request()->get('edit'))}}?locale=' + locale, {}, 50, null, 'GET')
            ...
            $("#save").on("click", function (event) {
                ...
                PUQajax('{{route('admin.api.product_attribute.put', request()->get('edit'))}}?locale=' + locale, formData, 5000, $(this), 'PUT', $form)
                    .then(function (response) {
                        loadFormData(locale);
                    });
            });
