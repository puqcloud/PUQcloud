        ...
        <div class="card-body">
            <form id="createForm" novalidate="novalidate">
                ...
                <div class="position-relative mb-3">
                    <label for="client" class="form-label">{{__('main.Client')}}</label>
                    <select name="client" id="client" class="form-select mb-2 form-control"></select>
                </div>
                <div id="client_data"></div>

                <div class="position-relative mb-3">
                    <label for="product" class="form-label">{{__('main.Product')}}</label>
                    <select name="product" id="product" class="form-select mb-2 form-control"
                            disabled></select>
                </div>


                <div class="position-relative mb-3">
                    <label for="product_price" class="form-label">{{__('main.Price')}}</label>
                    <select name="product_price" id="product_price" class="form-select mb-2 form-control"
                            disabled></select>
                </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            const $product_select = $("#product");
            const $product_price_select = $("#product_price");
