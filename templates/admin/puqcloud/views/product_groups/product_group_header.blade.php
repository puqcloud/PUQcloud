        ...
        <div class="page-title-heading">
            <div>
                <div class="page-title-head center-elem m-0">
                                            ...
                                            </span>{{ __('main.Product Group') }}
                    <span data-key="product_group" class="d-inline-block"></span>
                </div>
                <div class="page-title-subheading opacity-10">
                    <nav class="" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{route('admin.web.product_groups')}}">{{ __('main.Product Groups') }}</a>
                            </li>
        ...
        @foreach($tabs as $key => $label)
            <li class="nav-item">
                <a
                        ...
                        href="{{ route('admin.web.product_group.tab', ['uuid' => $uuid, 'tab' => $key]) }}"
