    ...
    <script>
        $(document).ready(function () {
            ...
            function loadSettings() {
                PUQajax('{{route('admin.api.dashboard.widgets.get')}}', {}, 500, null, 'GET')
            ...
            function loadWidgets() {
                ...
                PUQajax('{{ route('admin.api.dashboard.get') }}', {}, 500, null, 'GET')
                    .then(function (response) {
            ...
            function saveDashboardState() {
                ...
                PUQajax('{{ route('admin.api.dashboard.put') }}', {widgets: widgets}, 500, null, 'PUT')
                    .then(function () {
            ...
            function addWidgetToGrid(key, width, height, name, icon, x = null, y = null, autoRefresh = false, isInitialLoad = false) {
                ...
                PUQajax(`{{ route('admin.api.dashboard.widget.get', '') }}?key=${key}`, {}, 500, null, 'GET')
                    .then(function (response) {
                        let widget = $(`
