...
@section('content')
    ...
    <form id="product_option_group" class="mx-auto" novalidate="novalidate">
    ...
    <script>
        $(document).ready(function () {
            ...
            function loadFormData(locale) {
                blockUI('product_option_group');
                const $form = $('#product_option_group');

                $form[0].reset();
                resetFormValidation($form);

                PUQajax('{{route('admin.api.product_option_group.get', $uuid)}}?locale=' + locale, {}, 50, null, 'GET')
                    .then(function (response) {
                        ...
                        if (response.data) {
                            unblockUI('product_option_group');
                        }
            ...
            $("#save").on("click", function (event) {
                ...
                PUQajax('{{route('admin.api.product_option_group.put', $uuid)}}?locale=' + locale, formData, 5000, $(this), 'PUT', $form)
                    .then(function (response) {
                        loadFormData(locale);
                    });
            });
