        ...
        <div class="page-title-heading">
            <div>
                <div class="page-title-head center-elem m-0">
                                            ...
                                            </span>{{ __('main.Product Option Group') }}
                    <span data-key="product_option_group" class="d-inline-block"></span>
                </div>
                <div class="page-title-subheading opacity-10">
                    <nav class="" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{route('admin.web.product_option_groups')}}">{{ __('main.Product Option Groups') }}</a>
                            </li>
        ...
        @foreach($tabs as $key => $label)
            <li class="nav-item">
                <a
                    ...
                    href="{{ route('admin.web.product_option_group.tab', ['uuid' => $uuid, 'tab' => $key]) }}"
