...
@section('content')
            ...
            <div class="page-title-heading">
                <div>
                    <div class="page-title-head center-elem">
                        ...
                        <span class="d-inline-block">{{__('main.Product Option Groups')}}</span>
                    </div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <table style="width: 100%;" id="product_option_group" class="table table-hover table-striped table-bordered">
                <thead>
                <tr>
                    <th>{{__('main.Icon')}}</th>
                    <th>{{__('main.Key')}}</th>
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            var $tableId = $('#product_option_group');
            var ajaxUrl = '{{ route('admin.api.product_option_groups.get') }}';
            var columnsConfig = [
                {
                    data: "images",
            ...
            $('#modalSaveButton').on('click', function (event) {
                ...
                if ($('#createForm').length) {
                    ...
                    PUQajax('{{ route('admin.api.product_option_group.post') }}', formData, 50, $(this), 'POST', $form)
                        .then(function (response) {
