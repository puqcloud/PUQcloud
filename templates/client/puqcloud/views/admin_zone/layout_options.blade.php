...
@section('content')
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div> {{ __('client_template.Layout Options') }}
    ...
    <div class="theme-settings__options-wrapper">
        ...
        <form id="layout_options">
            ...
            <input type="hidden" id="client_area_header_color_scheme" name="client_area_header_color_scheme"
                   value="{{ setting('clientAreaLayoutOptionHeaderColorScheme') }}">

            <input type="hidden" id="client_area_sidebar_color_scheme" name="client_area_sidebar_color_scheme"
                   value="{{ setting('clientAreaLayoutOptionSidebarColorScheme') }}">

            <div class="main-card mb-3 card">
                <div class="card-header">
                    {{__('client_template.Layout Options')}}
                </div>
                <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="main-card mb-3 card">
                        <div class="card-header {{ setting('clientAreaLayoutOptionHeaderColorScheme') }}"
                             id="header_color">
                        ...
                        <div class="card-body">
                            <div class="form-check form-switch mb-2">
                                <label class="form-check-label" for="client_area_fixed_header">
                                    {{ __('client_template.Fixed Header') }}
                                </label>
                                <input type="checkbox" class="form-check-input" id="client_area_fixed_header"
                                       name="client_area_fixed_header"
                                       @if(!empty(setting('clientAreaLayoutOptionFixed_header'))) checked @endif>
                ...
                <div class="col-md-6 col-12">
                    <div class="main-card mb-3 card">
                        <div class="card-header {{ setting('clientAreaLayoutOptionSidebarColorScheme') }}"
                             id="sidebar_color">
                            {{__('client_template.Sidebar Options')}}
                            <div class="btn-actions-pane-right">
                                <button type="button"
                        ...
                        <div class="card-body">
                            <div class="form-check form-switch mb-2">
                                <label class="form-check-label" for="client_area_fixed_sidebar">
                                    {{ __('client_template.Fixed Sidebar') }}
                                </label>
                                <input type="checkbox" class="form-check-input" id="client_area_fixed_sidebar"
                                       name="client_area_fixed_sidebar"
                                       @if(!empty(setting('clientAreaLayoutOptionFixed_sidebar'))) checked @endif>
                            </div>
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <h5 class="pb-2">{{__('client_template.Choose Color Scheme')}}</h5>
    ...
    <script>
        $(document).ready(() => {
            ...
            function loadFormData() {
                PUQajax('{{ route('admin.api.client_template.layout_options.get') }}', {}, 50, null, 'GET')
            ...
            $('.switch-header-cs-class[data-class]').on('click', function () {
                ...
                $('#client_area_header_color_scheme').val(newClass);
            });

            $('.switch-header-cs-class[data-class=""]').on('click', function () {
                $('#header_color').attr('class', 'card-header');
                $('#client_area_header_color_scheme').val('');
            });

            $('.switch-sidebar-cs-class[data-class]').on('click', function () {
                const newClass = $(this).data('class');
                $('#sidebar_color').attr('class', `card-header ${newClass}`);
                $('#client_area_sidebar_color_scheme').val(newClass);
            });

            $('.switch-sidebar-cs-class[data-class=""]').on('click', function () {
                $('#sidebar_color').attr('class', 'card-header');
                $('#client_area_sidebar_color_scheme').val('');
            });
            ...
            $("#save").on("click", function (event) {
                ...
                serializeForm($form, true).then(function (formData) {
                    PUQajax(
                        '{{route('admin.api.client_template.layout_options.put')}}',
                        formData,
                        1000,
                        $button,
                        'PUT',
