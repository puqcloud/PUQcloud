    ...
    <script>
        $(document).ready(function () {
            ...
            function loadFormData() {
                ...
                PUQajax('{{ route('admin.api.Product.puqProxmox.app_preset.script.get', ['uuid'=>$uuid,'type'=>$type]) }}', {}, 50, null, 'GET')
            ...
            $("#save").on("click", function (event) {
                ...
                PUQajax('{{ route('admin.api.Product.puqProxmox.app_preset.script.put', ['uuid'=>$uuid,'type'=>$type]) }}', formData, 3000, $(this), 'PUT', $form)
                    .then(function (response) {
                        loadFormData();
                    });
            });
