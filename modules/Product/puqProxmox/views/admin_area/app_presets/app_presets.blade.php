...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            var tableId = '#app_presets';
            var ajaxUrl = '{{ route('admin.api.Product.puqProxmox.app_presets.get') }}';
            var columnsConfig = [
                {
                    data: "name",
                    name: "name"
            ...
            <form id="createForm" class="col-md-10 mx-auto">
                ...
                <div class="mb-3">
                    <label for="puq_pm_lxc_preset_uuid" class="form-label">{{ __('Product.puqProxmox.LXC Preset') }}</label>
                    <select name="puq_pm_lxc_preset_uuid" id="puq_pm_lxc_preset_uuid" class="form-select mb-2 form-control"></select>
                </div>
                ...
                <div class="mb-3">
                    <label for="certificate_authority_uuid" class="form-label">{{ __('Product.puqProxmox.Certificate Authority') }}</label>
            ...
            $('#modalSaveButton').on('click', function (event) {
                ...
                if ($('#createForm').length) {
                    ...
                    PUQajax('{{route('admin.api.Product.puqProxmox.app_preset.post')}}', formData, 500, $(this), 'POST', $form)
                        .then(function (response) {
