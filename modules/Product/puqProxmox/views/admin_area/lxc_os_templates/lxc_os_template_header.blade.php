                ...
                <div class="page-title-subheading opacity-10">
                    <nav class="" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{route('admin.web.Product.puqProxmox.lxc_os_templates')}}">{{ __('Product.puqProxmox.LXC OS Templates') }}</a>
                            </li>
    ...
    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav p-0">
        @php
            $tabs = [
                ...
                'post_install_script' => __('Product.puqProxmox.Post Install Script'),
                'reset_password_script' => __('Product.puqProxmox.Reset Password Script'),
            ];
        @endphp
        ...
        @foreach($tabs as $key => $label)
            <li class="nav-item">
                <a
                    ...
                    href="{{ route('admin.web.Product.puqProxmox.lxc_os_template.tab', ['uuid' => $uuid, 'tab' => $key]) }}"
