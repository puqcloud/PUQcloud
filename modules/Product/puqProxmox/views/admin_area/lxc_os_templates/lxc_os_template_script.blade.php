    ...
    <script>
        $(document).ready(function () {
            ...
            function loadFormData() {
                ...
                PUQajax('{{ route('admin.api.Product.puqProxmox.lxc_os_template.script.get', ['uuid'=>$uuid,'type'=>$type]) }}', {}, 50, null, 'GET')
                    .then(function (response) {
                        $("#script").val(response.data?.script);
                        ...
                        if (!window.editor) {
                            ...
                            const editorHeight = windowHeight - offsetTop - 400;
            ...
            $("#save").on("click", function (event) {
                ...
                PUQajax('{{ route('admin.api.Product.puqProxmox.lxc_os_template.script.put', ['uuid'=>$uuid,'type'=>$type]) }}', formData, 3000, $(this), 'PUT', $form)
                    .then(function (response) {
                        loadFormData();
                    });
            });
