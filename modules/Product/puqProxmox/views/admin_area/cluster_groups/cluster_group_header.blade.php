                ...
                <div class="page-title-subheading opacity-10">
                    <nav class="" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{route('admin.web.Product.puqProxmox.cluster_groups')}}">{{ __('Product.puqProxmox.Cluster Groups') }}</a>
                            </li>
        ...
        @foreach($tabs as $key => $label)
            <li class="nav-item">
                <a
                    ...
                    href="{{ route('admin.web.Product.puqProxmox.cluster_group.tab', ['uuid' => $uuid, 'tab' => $key]) }}"
