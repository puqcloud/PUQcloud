...
<div class="row mb-4">
    ...
    <div class="col-12 col-md-6 col-xl-2 mb-3">
        <label for="puq_pm_app_preset_uuid" class="form-label">
            {{ __('Product.puqProxmox.APP Preset') }}
        </label>
        <select name="puq_pm_app_preset_uuid" id="puq_pm_app_preset_uuid" class="form-select"></select>
    </div>
    ...
    <div class="col-12 col-md-6 col-xl-2 mb-3">
        <label for="mp_size_product_option_group_uuid" class="form-label">
            {{ __('Product.puqProxmox.Disk Size Option Group') }}
        </label>
...
<script>
    initializeSelect2(
        ...
        '{{ route('admin.api.Product.puqProxmox.app_presets.select.get') }}',
