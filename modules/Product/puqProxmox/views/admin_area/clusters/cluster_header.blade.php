                ...
                <div class="page-title-subheading opacity-10">
                    <nav class="" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{route('admin.web.Product.puqProxmox.clusters')}}">{{ __('Product.puqProxmox.Clusters') }}</a>
                            </li>
    ...
    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav p-0">
        @php
            $tabs = [
                ...
                'nodes' => __('Product.puqProxmox.Nodes'),
        ...
        @foreach($tabs as $key => $label)
            <li class="nav-item">
                <a
                    ...
                    href="{{ route('admin.web.Product.puqProxmox.cluster.tab', ['uuid' => $uuid, 'tab' => $key]) }}"
