    ...
    <script>
        $(document).ready(function () {
            ...
            function loadScheduleData() {
                ...
                PUQajax("{{ route('client.api.cloud.service.module.get', ['uuid' => $service_uuid, 'method' => 'getAppBackupSchedule']) }}", {}, 50, null, 'GET')
            ...
            $('#schedule_save').on('click', function (event) {
                ...
                if ($('#schedule_form').length) {
                    ...
                    PUQajax('{{ route('client.api.cloud.service.module.post', ['uuid' => $service_uuid, 'method' => 'postAppBackupSchedule']) }}', formData, 500, $(this), 'POST', $form)
                        .then(function (response) {
                            loadScheduleData();
                        });
                }
