...
@section('js')
    ...
    `;
            ...
            function updateProductOptions() {
                ...
                PUQajax(`{{ route('client.api.cloud.service.module.get', ['uuid' => $service_uuid, 'method' => 'getLxcRescaleOptions']) }}`, {}, 50, null, 'GET')
                    .then(response => {
            ...
            function updateOrderSummary() {
                ...
                PUQajax('{{ route('client.api.cloud.service.module.get', ['uuid' => $service_uuid, 'method' => 'getLxcRescaleCalculateSummary']) }}', formData, 100, null, 'GET')
                    .then(response => {
    ...
    `;
            ...
            $("#btnCompleteProductConfig").on("click", function (event) {
                ...
                const $form = $("#rescaleForm");
                const formData = serializeForm($form);
                PUQajax('{{ route('client.api.cloud.service.module.get', ['uuid' => $service_uuid, 'method' => 'postLxcRescale']) }}', formData, 50, $(this), 'POST', $form)
                    .then(response => {
                        unblockUI('productOptions');
                        clearSummary();
