...
@section('js')
    ...
    <script>
        function loadInfoData() {
            blockUI('info_card');
            PUQajax("{{ route('client.api.cloud.service.module.get', ['uuid' => $service_uuid, 'method' => 'getLxcBackupsInfo']) }}", {}, 50, null, 'GET')
        ...
        $(document).ready(function () {
            $('#backup_now').on('click', function (event) {
                ...
                if ($('#backup_now_form').length) {
                    ...
                    PUQajax('{{ route('client.api.cloud.service.module.post', ['uuid' => $service_uuid, 'method' => 'postLxcBackupNow']) }}', formData, 500, $(this), 'POST', $form)
                        .then(function (response) {
                            loadInfoData();
                        });
                }
